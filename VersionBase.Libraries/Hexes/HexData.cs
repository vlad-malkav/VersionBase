...
namespace VersionBase.Libraries.Hexes
{
    public class HexData
    {
        ...
        public HexData(HexCoordinates hexCoordinates, string text, TileType tileType, double cellSize)
            : this(hexCoordinates, text, tileType)
        {
            CellSize = cellSize;
        }

        public HexData(HexCoordinates hexCoordinates, string text, TileType tileType)
        {
